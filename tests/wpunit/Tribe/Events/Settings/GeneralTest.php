...
class GeneralTest extends \Codeception\TestCase\WPTestCase
{
    ...
    public function test_currency_symbol_should_show_before_event_cost_if_currency_position_is_before() {
    ...
    public function test_currency_symbol_should_show_after_event_cost_if_currency_position_is_after() {
